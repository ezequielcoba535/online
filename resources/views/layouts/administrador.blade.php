...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="Imagenes/Usuarios/user3.jpg{{Session::get('foto')}}" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="Imagenes/Usuarios/user3.jpg" class="img-circle" alt="User Image">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019 <a href="#">CubiCode</a>.</strong> Todos los derechos reservados.
  </footer>
